    ...
    <section id="trust" ref={ref} className="relative py-16 sm:py-20 bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mx-auto w-12 h-[2px] bg-gradient-to-r from-aethon-orange to-aethon-yellow rounded-full" />
        </motion.div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 sm:gap-6 md:gap-8 items-center justify-items-center">
          {brands.map((brand, i) => (
            ...
            >
              {/* Logo container */}
              <div
                className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white border border-aethon-gray-dark/60 flex items-center justify-center group-hover:shadow-lg group-hover:border-aethon-orange/20 transition-all duration-300 group-hover:scale-105"
